...
public class S2 {
	...
	List <Integer> list3 = new ArrayList<>();// time
	list3.add(3);
	list3.add(2);
	list3.add((int) 1.5);
	...
	List<String> list8= new ArrayList<>(); // message
	list8.add("Dear "+ list1.get(0)+","+"\n Congratulations on taking a loan of "+list2.get(0)+" "
			+ "from Silicon Valley Bank. You requested to pay of an EMI of "+ list7.get(0)+ " for the next month ");
